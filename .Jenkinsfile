            ...
            parallel {
                stage('pylint') {
                    ...
                    steps {
                        ...
                        sh "docker build --pull -t ${pylintStageDockerImage} --build-arg BASEIMAGE="hepcloud/decision-engine-ci:${BRANCH:-latest}" --build-arg USER=$(id -u) --build-arg GROUP=$(id -g) -f decisionengine/.github/actions/pylint-in-sl7-docker/Dockerfile.jenkins decisionengine/.github/actions/pylint-in-sl7-docker/"
                ...
                stage('unit_tests') {
                    ...
                    steps {
                        ...
                        sh "docker build --pull -t ${unit_testsStageDockerImage} --build-arg BASEIMAGE="hepcloud/decision-engine-ci:${BRANCH:-latest}" --build-arg USER=$(id -u) --build-arg GROUP=$(id -g) -f decisionengine/.github/actions/unittest-in-sl7-docker/Dockerfile.jenkins decisionengine/.github/actions/unittest-in-sl7-docker"
                        echo "Run ${STAGE_NAME} tests"
                ...
                stage('rpmbuild') {
                    ...
                    steps {
                        ...
                        sh "docker build --pull -t ${rpmbuildStageDockerImage} --build-arg BASEIMAGE="hepcloud/decision-engine-ci:${BRANCH:-latest}" --build-arg USER=$(id -u) --build-arg GROUP=$(id -g) -f decisionengine/.github/actions/rpmbuild-in-sl7-docker/Dockerfile.jenkins decisionengine/.github/actions/rpmbuild-in-sl7-docker"
                        echo "Run ${STAGE_NAME} tests"
